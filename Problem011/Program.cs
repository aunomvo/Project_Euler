       ...
       @"08 02 22 97 38 15 00 40 00 75 04 05 07 78 52 12 50 77 91 08
        ...
        private static int SolveProblem()
        {
            ...
            for(var x = 0; x < 20; x++)
            {
                for(var y = 0; y < 17; y++)
                {
                    var temp = data[x][y]*data[x][y + 1]*data[x][y + 2]*data[x][y + 3];
                    if (temp > retval)
                        retval = temp;
                }
            }
            ...
            for (var x = 0; x < 17; x++)
            {
                for (var y = 0; y < 20; y++)
                {
                    var temp = data[x][y]*data[x + 1][y]*data[x + 2][y]*data[x + 3][y];
                    if (temp > retval)
                        retval = temp;
                }
            }
            ...
            for (var x = 0; x < 17; x++)
            {
                for (var y = 0; y < 17; y++)
                {
                    var temp = data[x][y]*data[x + 1][y + 1]*data[x + 2][y + 2]*data[x + 3][y + 3];
                    if (temp > retval)
                        retval = temp;
                }
            }
